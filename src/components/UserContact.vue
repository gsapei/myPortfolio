<template>
    <v-row class="px-4">
      <v-col>
        ...
        <v-row v-if="screenSize.width>600">
          <v-col>
...
export default {
  ...
  data(){
    ...
    const userContact = computed(() => userData.value.userContact);
    const userSocial = computed(() => userData.value.userSocial);
    onMounted(() => {
